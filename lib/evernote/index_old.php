<?php
  ...
  require_once(LIB_DIR . "/evernote/Thrift.php");
  require_once(LIB_DIR . "/evernote/transport/TTransport.php");
  require_once(LIB_DIR . "/evernote/transport/THttpClient.php");
  require_once(LIB_DIR . "/evernote/protocol/TProtocol.php");
  require_once(LIB_DIR . "/evernote/protocol/TBinaryProtocol.php");
  require_once(LIB_DIR . "/evernote/packages/Types/Types_types.php");
  require_once(LIB_DIR . "/evernote/packages/UserStore/UserStore.php");
  require_once(LIB_DIR . "/evernote/packages/NoteStore/NoteStore.php");
  ...
  function getAuthorizationUrl() {
    $rVal = AUTHORIZATION_URL . '?oauth_token=' . urlencode($_SESSION['requestToken']);
